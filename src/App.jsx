  ...
  return (
    ...
    <div className='container m-4 p-4'>
     <div className='m-auto border border-dark rounded border-5 w-50 bg-dark '>
      <button className='btn btn-primary m-2 border-dark rounded border-3' onClick={() => alert('Login clicked')}>Login</button> <button className='btn btn-primary border-dark rounded border-3' onClick={() => alert('Signup clicked')}>Signup</button>
